...
<div id="container_index">
  ...
  <div class="logintitle">Update Username</div>
  <div class="login">
    <form action="" method="post" name="verify">
      <div class="fields">
        <input type="text" name="username" placeholder="Username" value="<?=$username;?>" style="width: 250px"><br/><br/>
        <input type="password" name="password" placeholder="Enter Password" style="width: 250px"><br/><br/><br/><br/>
        <input type="text" name="new_username" placeholder="New Username" style="width: 250px">
      </div>
