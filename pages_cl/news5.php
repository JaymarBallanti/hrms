...
<body style="border-radius: 10px 10px 10px 10px;
    ...
    <section style="float:left; margin: 0 1.5%;  width: 63%;">
        <img src="../photos/5.jpg" style="width:850px; height:600px;"/>
    
    <article>
        <p style="text-indent:40px; text-align:justify;">See at <a href = "http://www.ifsu.edu.ph/">http://www.ifsu.edu.ph</a></p>
    </article>
    </section>
