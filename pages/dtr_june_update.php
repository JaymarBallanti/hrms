...
<div id="container_dtr">
  ...
  <section id="wrapper_em">
    <div class="lsidebar_dtr">
      <?php
        ...
        $sql = "SELECT * FROM june WHERE employee_id = '$employee_id'";
  ...
  $total_under_min = $row['total_under_min']; 
    ...
    <div class="content_dtr">
      ...
      <form name="dtr" action="dtr_june_update_ac.php" method="post">
    ...
    <div class ="submit">
      <ul>
        <li>
          ...
          <input type="button" onclick="window.location.replace('dtr_june.php')" style="width:100px; height:30px; font-style:bold; font-size:16px" name="cancel" value="Cancel">
        </li>
      </ul>
    </div>
    </form>
