...
<div id="container_dtr">
  ...
  <section id="wrapper_em">
    <div class="lsidebar_dtr">
      <?php
        ...
        $sql = "SELECT * FROM september WHERE employee_id = '$employee_id'";
  ...
  $total_under_min = $row['total_under_min']; 
    ...
    <div class="content_dtr">
      <div class="form_title"><p>Daily Time Record</p>
      <form name="dtr" action="dtr_september_update_ac.php" method="post">
      <table id="timesheet" style="width:100%; border:2px solid #8DC3E9">
        ...
        <?php
        include('dtr_inputs_update.php');
        ?>
    <div class ="submit">
      <ul>
        <li>
          <input type="submit" style="width:100px; height:30px; font-style:bold; font-size:16px" name="submit" value="Update">
          <input type="button" onclick="window.location.replace('dtr_september.php')" style="width:100px; height:30px; font-style:bold; font-size:16px" name="cancel" value="Cancel">
        </li>
      </ul>
    </div>
    </form>
