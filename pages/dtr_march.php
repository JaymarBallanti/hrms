...
<div id="container_dtr">
  ...
  <section id="wrapper_em">
    <div class="lsidebar_dtr">
      ...
      $per_page = 15;
      $pages_query = mysql_query("SELECT COUNT('id') FROM march");
      $pages = ceil(mysql_result($pages_query, 0) / $per_page);
      $page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
      $start = ($page - 1) * $per_page;
      $query = mysql_query("SELECT employee_id, first_name,
          last_name, middle_name FROM march ORDER BY last_name ASC LIMIT $start, $per_page");
      include('display_names_march.php');
      mysql_close($conn);
      ?>
    </div>
    <div class="content_dtr">
      <div class="form_title"><p>Add Employee Daily Time Record</p>
      <form name="dtr" action="dtr_form_save_march.php" method="post">
      <table id="timesheet" style="width:100%; border:2px solid #8DC3E9">
        ...
        <tr>
          ...
          <th colspan="2"><input type="text" style="width:100px" readonly ="true" value="March" name="month"></th>
    ...
    <div class ="submit">
      <ul>
        <li>
          ...
          <input class="button" type="button" onclick="window.location.replace('dtr_march.php')" style="width:100px; height:30px; font-style:bold; font-size:16px" name="cancel" value="Cancel">
        </li>
      </ul>
    </div>
    </form>
