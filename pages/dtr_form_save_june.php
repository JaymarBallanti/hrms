...
echo "<meta http-equiv='refresh' content='1;URL=dtr_june.php'/> <h1>Please fill up necessary information!</h1>\n";
}
else
{
...
echo "<meta http-equiv='refresh' content='1;URL=dtr_june.php'/><h1>Successfully Added</h1>\n";
mysql_close($conn);
