...
<section id="wrapper_em">
   ...
   <div class="form_title"><p><br/>Employee Record Update</p>
   <form name="record_update" ENCTYPE="multipart/form-data" method="post" action="../update_record.php">
               ...
               <table style="width:100%">
                  <tr>
                     ...
                     <td><select name="department" style="width:180px">
                        <option value="Engineering and Technology" name="eng_tech" <?php if($department == 'Engineering and Technology') { echo 'selected="selected"'; } ?>>Engineering and Technology</option>
                        <option value="Business Management" name="bus_mgt" <?php if($department == 'Business Management') { echo 'selected="selected"'; } ?>>Business Management</option>
                        <option value="Teacher Education" name="t_educ" <?php if($department == 'Teacher Education') { echo 'selected="selected"'; } ?>>Teacher Education</option>
                        <option value="Administration" name="administ" <?php if($department == 'Administration') { echo 'selected="selected"'; } ?>>Administration</option>
                        </select>
                  </tr>
                  <tr>
                     </td>
                     ...
                     <td><select name="employee_status" style="width:180px">
                        <option value="Active" <?php if($employee_status == 'Active') { echo 'selected="selected"'; } ?>>Active</option>
                        <option value="On Leave" <?php if($employee_status == 'On Leave') { echo 'selected="selected"'; } ?>>On Leave</option>
                        <option value="Inactive" <?php if($employee_status == 'Inactive') { echo 'selected="selected"'; } ?>>Inactive</option>
                        </select>
                     </td>
                     <td>Date Employed: </td>
                     <td><input type="date" style="width:180px" name="date_employed" value="<?=$date_employed;?>">*</td>
                  </tr>
                  <tr>
                     <td>Position: </td>
                     <td><input type="text" style="width:180px" name="position" id="position" value="<?=$position;?>"></td>
                     <td>Employment Status: </td>
                     <td><select name="employment_status" style="width:180px">
                        <option value="FT" <?php if($employment_status == 'FT') { echo 'selected="selected"'; } ?>>FT</option>
                        <option value="PT" <?php if($employment_status == 'PT') { echo 'selected="selected"'; } ?>>PT</option>
                        </select>
                     </td>
                  </tr>
                  <tr>
                     <td>Primary Teaching Discipline: </td>
                     <td><input type="text" placeholder="use Code" style="width:180px" name="teaching_discipline" value="<?=$teaching_discipline;?>">*</td>
                     <td>Professional License: </td>
                     <td><input type="text" placeholder="use Code" style="width:180px" name="prof_license" value="<?=$prof_license;?>">*</td>
                  </tr>
                  <tr>
                     <td>Tenure of Employment: </td>
                     <td><input type="text" placeholder="use Code" style="width:180px" name="tenure_employment" value="<?=$tenure_employment;?>">*</td>
                     <td>Faculty Rank: </td>
                     <td><input type="text" placeholder="use Code" style="width:180px" name="faculty_rank" value="<?=$faculty_rank;?>">*</td>
                  </tr>
                  <tr>
                     <td>Teaching Load: </td>
                     <td><input type="text" placeholder="use Code" style="width:180px" name="teaching_load" value="<?=$teaching_load;?>">*</td>
                     <td>Subjects Taught: </td>
                     <td><input name="subjects_taught" rows="5" cols="50" style="width:180px" value="<?=$subjects_taught;?>">*</td>
                  </tr>
               </table>
            </td>
            <td>
      ...
      <div class="pds_fields1"><p>Personal Data Sheet</p>
            ...
            <td style="padding-left:60px">
               <table style="width:100%">
                  ...
                  <tr>
                     ...
                     <td><input type="text" style="width:250px" name="agency_employee_no" value="<?=$agency_employee_no;?>"></td>
                  </tr>
                  <tr>
                     <td>TIN: </td>
         ...
         <table id="title_fam_bg" style="width:100%; font-size:18px"><tr><td>III. Educational Bacground</td></tr></table>
         <table id="pds_border" style="width:100%">
            <tr>
      ...
      <div class ="submit">
         <ul>
            <li>
               ...
               <input type="button" style="width:100px; height:30px; font-size:16px" onclick="window.location.replace('basic_info.php')" name="cancel" value="Cancel"></td>
            </li>
         </ul>
      </div>
      <br/>
