...
<body>        
              <table id = "form_e5" style="width:100%; 
                    cellpadding:5px; cell-spacing:0px; border-collapse:collapse">
                <tr>
                  <th colspan="13" style="text-align:left; font-weight:bold; font-size:14px" scope="colgroup">Name of Institution: &nbsp Ifugao State University-Lagawe Campus</th>
                </tr>
                <tr>
                <th colspan="13" style="text-align:left; font-weight:bold; font-size:14px" scope="colgroup">Region: &nbsp&nbsp Cordillera Administrative Region</th>
                </tr>
                <tr>
              ...
              { 
                ...
                echo "<td><center><a href='update_form.php?employee_id=".$row['employee_id']."'>Edit</a></td>";
                print "</tr>"; 
                } 
                print "</table>";
                ?>
