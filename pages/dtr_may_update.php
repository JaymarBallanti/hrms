...
<div id="container_dtr">
  ...
  $total_under_min = $row['total_under_min']; 
    ...
    <div class="content_dtr">
      ...
      <form name="dtr" action="dtr_may_update_ac.php" method="post">
    ...
    <div class ="submit">
      <ul>
        <li>
          ...
          <input type="button" onclick="window.location.replace('dtr_may.php')" style="width:100px; height:30px; font-style:bold; font-size:16px" name="cancel" value="Cancel">
        </li>
      </ul>
    </div>
    </form>
